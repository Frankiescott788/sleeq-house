...
const LoadingSkeleton = () => (
  <Card className="col-span-4 relative">
    ...
    <CardBody className="absolute z-10 bottom-0 left-0 right-0">
          ...
          >
            {galleryQuery.isLoading ? (
              ...
              filteredProjects.map((project) => (
                  <Card
                    className="relative cursor-pointer col-span-12 lg:col-span-4"
                    isPressable={true}
                  ...
                  >
                    <div className="flex justify-center overflow-hidden">
                      <Image
                        src={project.image}
                        className="h-80 object-cover transition-transform duration-300 group-hover:scale-105"
                        alt={project.title}
                      />
                    </div>
                    ...
                    <div className="flex justify-end absolute top-0 z-10 right-0 p-4">
                      <Chip
                        className="bg-primary text-white border border-white/10 backdrop-blur-sm"
                      >
                        {project.category}
                      </Chip>
                    </div>
                    ...
                    <CardBody className="absolute z-10 bottom-0 left-0 right-0">
                      <div className="backdrop-blur-sm border rounded border-white/20 p-4 bg-black/40">
                        <h3 className="text-xl font-semibold text-white">{project.title}</h3>
                        <p className="line-clamp-1 text-sm text-white/90">{project.description}</p>
                      </div>
                    </CardBody>
                  </Card>
              ))
