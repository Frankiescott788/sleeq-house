  ...
  return (
    <>
      ...
      <section className="py-20 px-4 sm:px-6 md:px-8 lg:px-20  text-white relative overflow-hidden pt-[20dvh]">
        ...
        {/* Background Image */}
        <div className="absolute inset-0 services-hero bg-cover bg-center  flex items-center" />
      ...
      <section className="py-16 px-4 sm:px-6 md:px-8 lg:px-20 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <Image 
                src="https://plus.unsplash.com/premium_photo-1726826569575-0a38e259da6a?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fHdvb2RlbiUyMGZ1cm5pdHVyZSUyMGJsYWNrJTIwbWFufGVufDB8fDB8fHww"
            ...
            <motion.div variants={cardVariants}>
              <Card className="bg-white h-full" shadow="sm">
                <CardBody className="p-8">
                  ...
                  <h4 className="text-2xl font-bold text-gray-900 mb-4">Custom Kitchens</h4>                  <p className="text-gray-600 mb-6 leading-relaxed">
      ...
      <section className="py-20 px-4 sm:px-6 md:px-8 lg:px-20 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            >
              <div className="mb-4">
                <span className="text-5xl font-bold text-amber-600/20">01</span>
              </div>
            ...
            >
              <div className="mb-4">
                <span className="text-5xl font-bold text-amber-600/20">02</span>
              </div>
              <h3 className="text-xl font-semibold mb-3">Design & Planning</h3>
              <p className="text-gray-600">Our team creates detailed designs and visualizations for your approval.</p>
              <svg 
                className="hidden md:block absolute top-12 right-0 transform translate-x-1/2" 
                width="80" 
                height="16" 
            ...
            >
              <div className="mb-4">
                <span className="text-5xl font-bold text-amber-600/20">03</span>
              </div>
              <h3 className="text-xl font-semibold mb-3">Production</h3>
              <p className="text-gray-600">Expert craftsmen build your custom pieces using premium materials.</p>
              <svg 
                className="hidden md:block absolute top-12 right-0 transform translate-x-1/2" 
                width="80" 
                height="16" 
            ...
            >
              <div className="mb-4">
                <span className="text-5xl font-bold text-amber-600/20">04</span>
              </div>
              <h3 className="text-xl font-semibold mb-3">Installation</h3>
              <p className="text-gray-600">Professional installation ensures perfect fit and finish in your home.</p>
            </motion.div>
          </div>
        </div>
      </section>
